    ...
    return (
        <>
            ...
            <ul className='pl-4'>
                ...
                <li className="my-1">New feature: A endpoint with one coordenate that change position every minute (but the new location need to be close than the previus one</li>
            </ul>
