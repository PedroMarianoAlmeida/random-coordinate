...
const TrackingOriginPoint = () => {
    ...
    return (
        <>
            ...
            <div className='my-2 text-center'><p className='inline'>Endpoint:</p> <code className='bg-black p-2 text-white break-all text-left'>{`${process.env.ADDRESS}/${endPoint}`}</code></div>
