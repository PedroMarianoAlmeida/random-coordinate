...
const TrackingOriginPoint = () => {
    ...
    return (
        <>
            ...
            <h1 className={tailwindDirective.exampleTitle}>Random Cirular By Origin Point - Example</h1>

            <form className="text-sm font-semibold">
                <div className='text-center my-3 border border-black rounded p-2 mx-4 grid sm:flex sm:justify-around'>
